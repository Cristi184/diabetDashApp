...
DROP TABLE IF EXISTS app_adf262f319_messages CASCADE;

-- Create messages table for patient-doctor chat
CREATE TABLE app_adf262f319_messages (
...
CREATE INDEX messages_sender_idx ON app_adf262f319_messages(sender_id);
CREATE INDEX messages_receiver_idx ON app_adf262f319_messages(receiver_id);
CREATE INDEX messages_created_at_idx ON app_adf262f319_messages(created_at DESC);
CREATE INDEX messages_conversation_idx ON app_adf262f319_messages(sender_id, receiver_id, created_at DESC);
